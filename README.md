...
Create a **Dockerfile** and wrap your Oracle server instance inside a docker image.
Create a container, and create a run script to load the database each time it runs (or use tmpfs).  
Use the container instead of the local Oracle server instance.
...
## 3. Git repository
- Create your own github account, and initialize a new git repository called "Servlets-projects".  
...
Using the provided template https://github.com/dipkinholkar/servlet-projects/blob/main/README.md integrate the previous features using Servlets, JSPs, JSTL, and Tags.  
